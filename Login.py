...
side_img_data = Image.open("G:/GITHUB/GUI/images/side-img.png")
email_icon_data = Image.open("G:/GITHUB/GUI/images/email-icon.png")
password_icon_data = Image.open("G:/GITHUB/GUI/images/password-icon.png")
...
CTkButton(master=frame, text="Login", fg_color="#601E88", hover_color="#E44982", font=("Arial Bold", 12), text_color="#ffffff", width=225, command=validate_credentials).pack(anchor="w", pady=(40, 0), padx=(25, 0))
